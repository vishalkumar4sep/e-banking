...
const transferedInSchema = new mongoose.Schema(
  {
    ...
    balance_transfered: {
      ...
      min: [50, "You Can Not Transfer Balance Less Than Rs.50"],
    },
  },
  {
    timestamps: true,
...
const withdrawLogSchema = new mongoose.Schema(
  {
    withdrawed_amount: {
      ...
      min: [100, "You Can Not Withdraw Balance Less Than Rs.100"],
    },
  },
  {
    timestamps: true,
...
const depositLogSchema = new mongoose.Schema(
  {
    depositted_amount: {
      ...
      min: [100, "You Can Not Deposit Balance Less Than Rs.100"],
    },
  },
  {
    timestamps: true,
...
const accountSchema = new mongoose.Schema(
  {
    ...
    balance: {
      type: Number,
      default: 0,
      min: [0, "Balance Can Not Be Less Than Rs.0 !"],
    },
