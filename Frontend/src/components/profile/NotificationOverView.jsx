...
`}
  ...
  return (
    <div className="max-w-5xl w-full min-h-screen">
      <div className="h-full w-full p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
        {/* Heading */}
        <h3 className="flex justify-center items-center text-2xl text-white text-center font-bold px-2 py-4 mb-10 bg-slate-900 rounded shadow">
