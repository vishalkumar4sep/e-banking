...
export default function ProfileInfo({ info }) {
  return (
    <div className="w-full p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
      <h3 className="flex items-center  text-white mb-10 text-xl text-center font-bold px-2 py-4 my-4 rounded shadow bg-slate-900 ">
        <FcKindle className="mr-1" size={50} />
        Client Informations
      </h3>
      <div className="text-gray-700">
        <div className="grid md:grid-cols-2 gap-2">
          <div className="grid grid-cols-2 rounded shadow bg-blue-200">
          ...
          <div className="grid grid-cols-2 bg-blue-200  rounded shadow ">
          ...
          <div className="grid grid-cols-2 rounded shadow bg-blue-200">
            ...
            <div className="px-4 py-2  text-right">
              <span className="hover:text-red-700 hover:underline hover:underline-offset-2 break-all">
                {info.email}
              </span>
            </div>
          </div>
