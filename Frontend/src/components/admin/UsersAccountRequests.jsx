...
const UsersAccountRequests = ({ accountRequestsList }) => {
  ...
  return (
    <div className="max-w-5xl w-full block p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
      <h3 className="text-2xl my-10 p-3 text-center font-bold bg-slate-900 text-white rounded shadow-lg shadow-black/30">
      ...
      {(accountRequestsList.length !== 0 || isLoading) && (
        <div className="flex justify-center items-center flex-wrap md:flex-nowrap gap-4 mb-6 p-4 bg-blue-200 rounded-md">
          ...
          <input
            type="text"
            name="searchQuery"
            className="block w-full md:w-auto px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0
      ...
      {!searchQuery && filteredRequests.length === 0 && !isLoading && (
        <div className="bg-yellow-200 text-gray-800 text-center font-bold my-4 py-4 px-2 rounded">
      ...
      {searchQuery && filteredRequests.length === 0 && !isLoading && (
        <div className="bg-red-200 text-gray-800 text-center font-bold my-4 py-4 px-2 rounded">
