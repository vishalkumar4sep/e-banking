...
export const PaymentMethods = ({ title }) => {
  ...
  return (
    <div className="p-2 mb-5">
      {/* Heading */}
      <h3 className="text-base font-semibold text-gray-900 p-2 bg-blue-400 shadow-lg rounded">
        {title}
      </h3>
      ...
      <p className="text-xs font-bold my-2 underline text-red-500">
        *All Payments Methods Are FAKE Just Type Any Values.
      </p>

      {/* Methods inputs Details */}
      {method === paymentMethods[0].title && <DebitCard />}
