...
export default function UpdateAdmin() {
  ...
  if (info)
    return (
      <div className="max-w-4xl w-full self-start block p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
        <h3 className="flex justify-center items-center text-2xl text-white italic font-bold text-center px-2 py-4 mb-10 rounded shadow bg-slate-900 ">
