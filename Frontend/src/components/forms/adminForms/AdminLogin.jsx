...
export default function AdminLogin() {
  ...
  return (
    <div className="block p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 max-w-md w-full mx-auto">
      <Logo />
      <h3 className="flex justify-center items-center text-2xl text-white font-bold text-center p-2 my-4 rounded shadow bg-slate-900 select-none">
        <FcPrivacy size={45} />
