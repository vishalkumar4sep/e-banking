...
export const AccountRequest = () => {
  ...
  return (
    <div className="max-w-5xl w-full block p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
      <h3 className="flex justify-center items-center text-xl text-center font-bold px-2 py-4 mb-10 bg-slate-900 text-white rounded shadow ">
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex justify-center items-center font-semibold flex-wrap gap-4 mb-5 p-2">
          <label
            className="basis-full sm:basis-[40%] text-md  my-2 sm:my-0  p-2 rounded shadow bg-blue-200"
