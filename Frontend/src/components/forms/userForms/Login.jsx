...
export default function Login() {
  ...
  return (
    <div className="w-full lg:w-[40%] max-w-md block p-6 rounded shadow-lg shadow-black/30 bg-yellow-50 mx-auto">
      <Logo />
      <h3 className="flex justify-center items-center text-2xl text-white font-bold text-center p-4 my-4 rounded shadow bg-slate-900 select-none">
        <span>Login</span>
      </h3>
