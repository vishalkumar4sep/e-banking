...
export const DepositLogs = () => {
  ...
  const depositLog = (log) => {
    return (
      <li
        key={log._id}
        className="min-h-[150px] my-4 flex flex-col gap-2 items-center justify-center flex-wrap bg-blue-200 p-4 rounded shadow"
      >
  ...
  if (!depositLogs || depositLogs.length === 0)
    return (
      <div className="max-w-2xl w-full mx-auto my-4 flex flex-col gap-4 items-center justify-center flex-wrap  bg-pink-100 p-4 rounded shadow">
  ...
  return (
    <div className="max-w-5xl w-full self-start p-7 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
      <h3 className="flex justify-center items-center text-2xl text-center font-bold px-2 py-4 mb-10 bg-slate-900 text-white rounded shadow ">
