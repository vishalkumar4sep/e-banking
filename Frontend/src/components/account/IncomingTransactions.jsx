...
export const IncomingTransactions = () => {
  ...
  const incomingTransaction = (transaction) => {
    return (
      <li
        key={transaction._id}
        className="min-h-[150px] my-4 flex flex-col gap-2 items-center justify-center flex-wrap bg-slate-900 texy-white p-4 rounded shadow"
      >
  ...
  return (
    <div className="max-w-5xl w-full self-start p-6 rounded shadow-lg shadow-black/50 bg-yellow-50 mx-auto">
      <h3 className="flex justify-center items-center text-2xl text-center font-bold px-2 py-4 mb-10 bg-blue-400 rounded shadow ">
