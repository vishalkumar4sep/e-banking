...
export const AccountDetails = ({ account }) => {
  return (
    <div className="flex items-center justify-center flex-col gap-4 px-6 py-8 my-10 rounded rounded">
      <h3 className="w-full flex items-center text-xl my-5 p-3 text-left font-bold text-white bg-slate-900 rounded">
        <FcRating className="mr-1" size={35} />
        Account Details:-
      </h3>

      <div className="w-full flex justify-between items-center flex-col  lg:flex-row gap-2 lg:gap-0 p-3 text-white text-center font-semibold bg-blue-200 rounded shadow">
