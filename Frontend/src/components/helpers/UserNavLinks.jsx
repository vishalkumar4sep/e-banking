    ...
    >
      {link.title === "Logout" ? (
        <button
          ...
          className="w-full flex items-center p-2 rounded shadow bg-red-200 hover:bg-red-100"
        >
        ...
        <Link
          to={link.to}
          className="w-full flex items-center p-2 rounded shadow bg-blue-200 
          hover:bg-blue-100"
        ...
        >
          ...
          <span
            className={`text-sm ml-2 text-blue-800 hover:text-blue-700 ${
